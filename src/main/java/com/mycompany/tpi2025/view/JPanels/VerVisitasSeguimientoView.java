 ...
 * @author aquin
 */
public class VerVisitasSeguimientoView extends javax.swing.JPanel {

    /**
     * Creates new form CrearDiagnosticoView
     */
    public VerVisitasSeguimientoView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        eliminarBtn.setText("Eliminar Visita");

        jLabel4.setText("Visitas de seguimiento registradas");
        ...
        tablaDatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Tarea", "Voluntario", "ID Gato", "Fecha", "Descripcion"
            }
        ) {
    ...
    public void reloadTable(List<VisitaSeguimiento> elementos) {
