 ...
 * @author aquin
 */
public class VerHogarView extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(VerHogarView.class.getName());

    /** Creates new form VerHogarView */
    public VerHogarView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new VerHogarView().setVisible(true));
    }
    ...
    public void reloadTable(List<Hogar> elementos) {
        DefaultTableModel model = (DefaultTableModel) tablaDatos.getModel();
        model.setRowCount(0);
        for (Hogar elem : elementos) {
